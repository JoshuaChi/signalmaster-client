        ...
        1: [
            function (e, t) {
                function n(e) {
                    ...
                    this.capabilities = r, i.call(this), n = this.connection = io.connect(this.config.url), n.on("connect", function () {
        ...
        12: [
            function (e, t) {
                ...
                t.exports = function (e, t) {
                    ...
                    a = d.createAnalyser(), a.fftSize = 512, a.smoothingTimeConstant = c, s = new Float32Array(a.fftSize), e.jquery && (e = e[0]), e instanceof HTMLAudioElement ? (r = d.createMediaElementSource(e), "undefined" == typeof h && (h = !0), u = u || -65) : (r = d.createMediaStreamSource(e), u = u || -45), r.connect(a), h && a.connect(d.destination), i.speaking = !1, i.setThreshold = function (e) {
                        u = e
                    ...
                    var l = function () {
                        setTimeout(function () {
                            var e = n(a, s);
                            i.emit("volume_change", e, u), e > u ? i.speaking || (i.speaking = !0, i.emit("speaking")) : i.speaking && (i.speaking = !1, i.emit("stopped_speaking")), l()
                        }, p)
                    };
                    return l(), i
                }
    ...
    function (e, t) {
        ...
        n.encodePacket = function (e) {
            ...
            case "event":
                ...
                e.args && e.args.length && (l.args = e.args), u = s.stringify(l);
                break;
            case "json":
